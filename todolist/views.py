...
def delete_task(request, task_id):
    ...
    if task.manager == request.user:
        ...
        messages.error(request, 'Access is restricted, You are Not Allowed!')
...
def edit_task(request, task_id):
    if request.method == 'POST':
        ...
        return render(request, 'todolist/edit.html', {'task_obj': task_obj})
...
def complete_task(request, task_id):
    ...
    messages.success(request, 'Task Status has changed!')
    return redirect('todolist:todolist')
...
def index(request):
    context = {
        'index_txt': 'Welcome to ToDoList Home Page'
    }
